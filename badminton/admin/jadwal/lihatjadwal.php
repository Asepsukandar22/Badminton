    ...
    <style>
        ...
        table, tbody, td, tfoot, th, thead, tr {
            ...
            <div class="alert alert-warning" role="alert">
                   <b>Perhatian</b>, Jadwal yang ditambahkan Oleh <b>Admin</b> Hanya Untuk Boking <b>1 Jam</b>
                    </div>
<body class="bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-1"> 
                ...
                <button type="button" class="btn btn-danger btn-sm ml-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
<?php
			if (isset($_POST['boking'])) {
                        ...
                        if ($tgl_boking < $tgl_sekarang) {
                            ...
                            $sql = mysqli_query($koneksi,"INSERT INTO schedule_list VALUES ('','$nama_klub','$start_datetime','$end_datetime','$id_lap','$id_user','$id_member','$id_jadwal','$statusboking')");
                                if ($sql){
                                    ?>
                                    <script type="text/javascript">
