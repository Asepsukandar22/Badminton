...
$id = $_GET['id'];
$query = mysqli_query($koneksi," SELECT * FROM schedule_list INNER JOIN pemesanan ON pemesanan.id = schedule_list.id INNER JOIN lapangan ON schedule_list.id_lap = lapangan.id_lap WHERE schedule_list.id = '$id' ");
